...
import { fetchBatchList, fetchMaterialList, postBatch } from "../../services/batchService"
...
export const postBatchData=createAsyncThunk('batch/postData',async(data,thunkApi)=>{
    try{
...
export const getBatchList=createAsyncThunk('batch/batchList',async(_,thunkApi)=>{
    try{
...
export const getMaterialList=createAsyncThunk('batch/materialList',async(_,thunkApi)=>{
    try{
